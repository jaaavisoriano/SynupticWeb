;(function($, window, document, _){
	...
	var IconSelect = {
		...
		changeUrl: function(parent){
			$(parent).find('.dev-icon-link-url input[type="text"]').on('keyup', function(){
				var $this = $(this),
					value = $this.val();
		...
		status: function(parent){
			$(parent).find('.dev-icon-enabled input[type="checkbox"]').on('change', function(){
				var $this = $(this);
		...
		removeButton: function(parent){
			...
			$(parent).find('.dev-icon-reset').on('click', function(event){
				event.preventDefault();
				if(confirm("Are you sure!!")){
